...
// L2_BITS=12.
//---------------------------D-114-------------------------------------------//
#define	MEMORY_L1_PAGE_SIZE_BITS 13	// each entry in L1 is 64 KB, since it is 8KB pages now, it will be 13 bits 
...
//-----------D-114------------------//
#define L1_MAX_ENTRIES 0x0040	// max entries in L1 table is 64, as virtual address space is 512KB per process 
//-----------D-114------------------//
